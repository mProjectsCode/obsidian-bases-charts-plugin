...
<div class="bases-chart-container" bind:clientHeight={height} bind:clientWidth={width}>
	<Plot grid color={{ legend: true, scheme: 'tableau10' }} x={{ label: xName, type: 'band' }} y={{ label: yName }} height={height} width={width - 16} class="bases-chart">
		<BarY data={data} x="group" y="y" stroke="group" />
	</Plot>
</div>
